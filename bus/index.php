<!DOCTYPE html>
 ...
 <div class="main">
   <div class="jumbotron">
  <h1>Hello, <?php echo $_SESSION['username'] ?></h1>
  <p>This dashboard will give you a statistical summary of the system</p>
</div>
<div>
  <?php
  ...
  if ($result = $mysqli->query("SELECT driver_id FROM driver_details ORDER BY driver_id")) {
      ...
      /* determine number of drivers rows result set */
  ...
  if ($result = $mysqli->query("SELECT id FROM route")) {

      /* determine number of routes rows result set */
  ...
  if ($result = $mysqli->query("SELECT no_plate FROM bus_details")) {
      ...
      /* determine number of buses result set */
  ...
  if ($result = $mysqli->query("SELECT id FROM booking")) {
      ...
      /* determine number of booking result set */
